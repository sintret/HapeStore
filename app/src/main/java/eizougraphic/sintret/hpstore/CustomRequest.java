...
public class CustomRequest extends Request<JSONObject> {
    ...
    public CustomRequest(int method, String url, Map<String, String> params, Response.Listener<JSONObject> reponseListener, ErrorListener errorListener) {
